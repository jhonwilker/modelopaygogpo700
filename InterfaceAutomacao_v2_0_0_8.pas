...
unit InterfaceAutomacao_v2_0_0_8;
...
begin
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JAnimator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JAnimator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JAnimator_AnimatorListener', TypeInfo(InterfaceAutomacao_v2_0_0_8.JAnimator_AnimatorListener));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JAnimator_AnimatorPauseListener', TypeInfo(InterfaceAutomacao_v2_0_0_8.JAnimator_AnimatorPauseListener));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JKeyframe', TypeInfo(InterfaceAutomacao_v2_0_0_8.JKeyframe));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JLayoutTransition', TypeInfo(InterfaceAutomacao_v2_0_0_8.JLayoutTransition));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JLayoutTransition_TransitionListener', TypeInfo(InterfaceAutomacao_v2_0_0_8.JLayoutTransition_TransitionListener));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JPropertyValuesHolder', TypeInfo(InterfaceAutomacao_v2_0_0_8.JPropertyValuesHolder));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JStateListAnimator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JStateListAnimator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTimeInterpolator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTimeInterpolator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTypeConverter', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTypeConverter));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTypeEvaluator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTypeEvaluator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JValueAnimator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JValueAnimator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JValueAnimator_AnimatorUpdateListener', TypeInfo(InterfaceAutomacao_v2_0_0_8.JValueAnimator_AnimatorUpdateListener));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JPathMotion', TypeInfo(InterfaceAutomacao_v2_0_0_8.JPathMotion));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JScene', TypeInfo(InterfaceAutomacao_v2_0_0_8.JScene));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransition', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransition));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransition_EpicenterCallback', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransition_EpicenterCallback));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransition_TransitionListener', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransition_TransitionListener));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransitionManager', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransitionManager));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransitionPropagation', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransitionPropagation));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransitionValues', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransitionValues));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JInterpolator', TypeInfo(InterfaceAutomacao_v2_0_0_8.JInterpolator));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JToolbar_LayoutParams', TypeInfo(InterfaceAutomacao_v2_0_0_8.JToolbar_LayoutParams));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JAplicacaoNaoInstaladaExcecao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JAplicacaoNaoInstaladaExcecao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.Jinterfaceautomacao_BuildConfig', TypeInfo(InterfaceAutomacao_v2_0_0_8.Jinterfaceautomacao_BuildConfig));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JCartoes', TypeInfo(InterfaceAutomacao_v2_0_0_8.JCartoes));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JConfirmacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JConfirmacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JConfirmacoes', TypeInfo(InterfaceAutomacao_v2_0_0_8.JConfirmacoes));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JDadosAutomacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JDadosAutomacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JEntradaTransacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JEntradaTransacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JFinanciamentos', TypeInfo(InterfaceAutomacao_v2_0_0_8.JFinanciamentos));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JGlobalDefs', TypeInfo(InterfaceAutomacao_v2_0_0_8.JGlobalDefs));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JModalidadesPagamento', TypeInfo(InterfaceAutomacao_v2_0_0_8.JModalidadesPagamento));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JOperacoes', TypeInfo(InterfaceAutomacao_v2_0_0_8.JOperacoes));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JPersonalizacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JPersonalizacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JPersonalizacao_1', TypeInfo(InterfaceAutomacao_v2_0_0_8.JPersonalizacao_1));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JPersonalizacao_Builder', TypeInfo(InterfaceAutomacao_v2_0_0_8.JPersonalizacao_Builder));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JProvedores', TypeInfo(InterfaceAutomacao_v2_0_0_8.JProvedores));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JQuedaConexaoTerminalExcecao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JQuedaConexaoTerminalExcecao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JSaidaTransacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JSaidaTransacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JSenderActivity', TypeInfo(InterfaceAutomacao_v2_0_0_8.JSenderActivity));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JStatusTransacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JStatusTransacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTerminal', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTerminal));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTerminalDesconectadoExcecao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTerminalDesconectadoExcecao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTerminalNaoConfiguradoExcecao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTerminalNaoConfiguradoExcecao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransacao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransacao));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransacaoPendenteDados', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransacaoPendenteDados));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JTransacoes', TypeInfo(InterfaceAutomacao_v2_0_0_8.JTransacoes));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JVersoes', TypeInfo(InterfaceAutomacao_v2_0_0_8.JVersoes));
  TRegTypes.RegisterType('InterfaceAutomacao_v2_0_0_8.JViasImpressao', TypeInfo(InterfaceAutomacao_v2_0_0_8.JViasImpressao));
end;
